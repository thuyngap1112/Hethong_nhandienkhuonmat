    ...
    def show(self):
        ...
        def addNewUserFunc():
            ...
            if(len(getValueNumberIdAddNew) == 0 or len(getValueNameAddNew) == 0):
                ...
                messagebox.showinfo('Thông báo', 'Number Id must is isdecimal.')
        ...
        buttonAddNewUser = Button(addNewUserTrainModelScreen, text = 'Thêm sv mới', font = (fontTypeApp, 14), fg = 'white', bg = 'green',
