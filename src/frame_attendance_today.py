...
class FrameAttendanceToday:
    def show():
        ...
        lableTitleAttendanceToday = Label(attendanceTodayScreen, text = 'DANH SÁCH ĐIỂM DANH HÔM NAY', font = (fontTypeApp, 18),fg='green')
        ...
        treeviewAttendanceToday.heading(1, text = 'Mã số sinh viên')
        treeviewAttendanceToday.heading(2, text = 'Tên')
        treeviewAttendanceToday.heading(3, text = 'Ngày điểm danh')
        treeviewAttendanceToday.heading(4, text = 'Thời gian điểm danh')
        ...
        def selectItemAttendanceToday(event):
            ...
            def deleteRowAttendanceTodayFunc():
                ...
                messagebox.showinfo('message', 'Xoá thành công.')
            def viewImageAttendanceTodayFunc():
                ViewImage(pathViewToday, int(values[0])).view()

            buttonViewImageAttendanceToday = Button(attendanceTodayScreen, text = 'Xem ảnh', font = (fontTypeApp, 14), fg = 'white', bg = 'green',
                width = 10, height = 1, command = viewImageAttendanceTodayFunc)
            buttonViewImageAttendanceToday.place(x = 650, y = 60)
            buttonDeleteRowAttendanceToday= Button(attendanceTodayScreen, text = 'Xoá', font = (fontTypeApp, 14), fg = 'white', bg = 'green',
        ...
        def exportToExcelAttendanceToday():
            ...
            messagebox.showinfo('Thông báo', 'Đã xuất file excel thành công.')

        buttonExportToExcelAttendanceToday= Button(attendanceTodayScreen, text = 'Xuất file excel', font = (fontTypeApp, 14), fg = 'white', bg = 'green',
