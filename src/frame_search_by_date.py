...
class FrameSearchByDate:
    ...
    def show(self):
        ...
        searchByDateScreen.title('Danh sách điểm danh')
        ...
        treeViewSearch.heading(1, text = 'Mã số sinh viên')
        treeViewSearch.heading(2, text = 'Tên')
        treeViewSearch.heading(3, text = 'Ngày điểm danh')
        treeViewSearch.heading(4, text = 'Thời gian điểm danh')
